...
if(isset($_POST['simpan'])){
    ...
    if($jenis_barang && $merk && $harga && $stok && $foto){

        if($op=='edit'){
            $sql1="update barang set jenis_barang='$jenis_barang', merk='$merk' ,harga='$harga',stok='$stok', foto='$foto' where id_barang='$id_barang' ";
            $q1=mysqli_query($koneksi,$sql1);
            if($q1){
            ...
            $sql1="insert into barang(jenis_barang,merk,harga,stok,foto) values ('$jenis_barang','$merk','$harga','$stok','$foto')";
        $q1=mysqli_query($koneksi,$sql1);
        if($q1){
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label for="jenis_barang" class="form-label">jenis_barang</label></label>
                    ...
                    <div class="mb-3">
                        <label for="harga" class="form-label">stok</label></label>
                                ...
                                <?php
                                 ...
                                 while($r2=mysqli_fetch_array($q2)){
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row"><img src="img/<?=$foto?>" class="img-thumbnail" widht="100px" height="100px"></td>
                                        <td scope="row">
                                        <a href="admin.php?op=edit&id=<?php echo $id_barang ?>"> <button type="button" class="btn btn-danger">Edit</button></a>
                                        <a href="admin.php?op=delete&id=<?php echo $id_barang ?>"onclick="return confirm('yakin ingin delete?')"><button type="button" class="btn btn-warning">Delete</button></a>
