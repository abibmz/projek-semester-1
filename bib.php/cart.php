...
if (isset($_GET["action"])) {
    if ($_GET["action"] == "delete") {
        foreach ($_SESSION["cart"] as $keys => $value) {
            ...
            $alamat = $_POST['alamat'];
            $sql = mysqli_query($koneksi, "INSERT INTO transaksi_(total,tgl_transaksi,id_pembeli,alamat) value ('$total','".date("Y-m-d")."','$id_pembeli','$alamat')");
            }
       $id_transaksi = mysqli_insert_id($koneksi);
        foreach($_SESSION["cart"] as $key => $value){
            $id_produk = $value['product_id'];
            $quantity = $value['item_quantity'];
            $q1 = "INSERT INTO detail VALUES('','$id_transaksi','$id_produk','$quantity')";
                            ...
                            <div class="card border-0 ">
                                            ...
                                            <div class="row  justify-content-between">
                                                <div class="col-auto col-md-7">
                                                    <div class="media flex-column flex-sm-row">
                                                        <img class="rouned" src="bahanimg/<?= $value['foto']; ?>" width="62" height="62">
                                ...
                                <?php   try{
                                    ...
                                    <div class="row mb-5 mt-4 ">
                                        <div class="col-md-7 col-lg-6 mx-auto"><a class="btn btn-block btn-outline-primary btn-lg" href="index.php">TAMBAH PEMBELIAN</a></div>
                                    </div>
                                        </div>
                            </div>
                        </div>
